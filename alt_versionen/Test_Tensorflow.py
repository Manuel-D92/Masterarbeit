...
class config_Test_Tensorflow():
    ...
    # Path
    path = r"C:\Users\Dauser\Desktop\dauserml_Messungen_2020_07_22\Referenz_alfred"
    path_test_sequenz = r"C:\Users\Dauser\Desktop\dauserml_Messungen_2020_07_22\Referenz_alfred"
    filename_training = "\\all_Files.csv"
    ...
    loss_funktions = ['MSE']#, 'MAE', 'huber_loss']  # ,
    # 'logcosh', 'MAPE',
