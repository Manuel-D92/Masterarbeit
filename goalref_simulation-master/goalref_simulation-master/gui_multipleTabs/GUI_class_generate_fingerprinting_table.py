...
import os
__author__ = 'ihm'
## @package class_generate_fingerprinting_table
# @brief A class that contains necessary methods
# for generating the fingerprinting tables
# @details This python logic contains several methods to process the parameters configured by the user
# , to make them ready for genrating a table and to generate the final table.
#@author ihm
#@version 2.0
#@date Updated on Tue Aug 28 09:00:00 2018
